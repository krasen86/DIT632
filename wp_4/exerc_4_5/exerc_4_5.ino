...
#define DELAY_AFTER_PRESS 1000 // default delay after pressing a button
...
// Global variables
unsigned char input; // store the pressed button value
...
void loop()
{
    ...
    if(input != NOT_PRESSED){ // check if button has not been pressed
        ...
        delay(DELAY_AFTER_PRESS); // delay after pressing
    }
}

// Function to check which keypad button is pressed and return it if any
unsigned char checkForKeypadInput()
{
